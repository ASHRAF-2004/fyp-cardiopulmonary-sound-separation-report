...
check("Class diagram includes concrete non-NeoSSNet strategies", all(name in class_puml_text for name in ["FixedFilterStrategy", "NMFStrategy", "VMDStrategy", "NeoSSNetStrategy"]))
