...
3. Prepare public audio datasets.
...
| Dataset preparation | Select and organize public cardiopulmonary audio datasets. | Prepared dataset folder structure and metadata notes. |
...
| Documentation and project tracking | Markdown notes and project documentation files | Recording methodology, design decisions, and implementation progress. |
